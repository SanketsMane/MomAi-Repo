...
export const CustomizationForm = ({
  ...
  const form = useForm<FormSchema>({
    ...
    defaultValues: {
      ...
      defaultSuggestions: {
        suggestion1: initialData?.defaultSuggestions.suggestion1 || "Can you explain shift creation?",
        suggestion2: initialData?.defaultSuggestions.suggestion2 || "How do I get started?",
        suggestion3: initialData?.defaultSuggestions.suggestion3 || "What features are available?",
      },
      vapiSettings: {
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input
                            {...field}
                            placeholder="Can you explain shift creation?"
                          />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input
                            {...field}
                            placeholder="What features are available?"
                          />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
