                ...
                <>
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-sm text-gray-700 dark:text-gray-300">
                      {new Date(conversation.contactSession.expiresAt).toLocaleString()}
                    </p>
                  </div>
                </>
              )}
            ...
            <CardHeader className="pb-4">
              <CardTitle className="flex items-center gap-x-3 text-lg">
                <div className="p-2 bg-green-100 dark:bg-green-900/30 rounded-lg">
                  <MessageSquareIcon className="h-5 w-5 text-green-600 dark:text-green-400" />
                </div>
                System Details
              </CardTitle>
            </CardHeader>
                ...
                <>
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div className="space-y-2">
                      ...
                      <p className="text-sm text-gray-700 dark:text-gray-300">
                        {conversation.contactSession.metadata.platform || 'Not available'}
                      </p>
                    </div>
                    <div className="space-y-2">
                      <label className="text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider">
                      ...
                      <p className="text-sm text-gray-700 dark:text-gray-300">
                        {conversation.contactSession.metadata.language || 'Not available'}
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-sm text-gray-700 dark:text-gray-300">
                      {conversation.contactSession.metadata.screenResolution || 'Not available'}
                    </p>
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-sm text-gray-700 dark:text-gray-300">
                      {conversation.contactSession.metadata.timezone || 'Not available'}
                    </p>
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-xs text-gray-600 dark:text-gray-400 bg-gray-100 dark:bg-gray-700 p-3 rounded-lg border break-all leading-relaxed">
                      {conversation.contactSession.metadata.userAgent || 'Not available'}
                    </p>
                  </div>
